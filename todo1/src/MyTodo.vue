<template>
  <div>
    ...
    <input type="text" v-model="title" placeholder="할 일을 입력해주세요" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async addTodo() {
        try {
          const todo = {id: 0, title: this.title, dueDate: this.dueDate, done: false };
